...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="kembali_lembaga.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fas fa-users fa-fw"></i> Pengembalian Lembaga</a>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $("#lembaga").DataTable({
        ajax: "https://script.google.com/macros/s/AKfycbw_AXy3qu-IjI4WDy5SjxMTX1XTCE7hht8vCGi7j3tA2kKXvZjBWghsTmGqkk6OcQFmUw/exec",
        columns: [
        {
            title: "No.",
            data: null,
        ...
        },  
        {
          ...
          {
            title: "Foto kondisi barang inventaris setelah dipinjam",
            data: "Foto kondisi barang inventaris setelah dipinjam",
          },
          {
          ...
          {
            data: "Pernyataan Penerima",
            title: "Pernyataan Penerima",
          },
        ],
