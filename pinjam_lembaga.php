...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-container">
      <h5 class="w3-show-inline-block w3-amber w3-padding-small">Lembaga</h5>
    </div>
    <hr>
    <div class="w3-bar-block">
      ...
      <a href="pinjam_lembaga.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fas fa-users fa-fw"></i> Peminjaman Lembaga</a>
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><i class="fas fa-users"></i> Daftar Peminjaman Barang / <b>Lembaga</b></b></h5>
    </header>
    ...
    <div class="w3-panel">
      <div class="w3-row-padding" style="margin:0 -16px">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <h3 class="text-center mb-4">Daftar Peminjaman Barang - Lembaga</h3>
          <h4 class="text-center mb-4" id="packageName"></h4>
          <br />
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSd1TUfQMvy9kAlyYwj6Zhf8emrdPLnz12UnSLNOBRsPqh44pQ/viewform?usp=sf_link"
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLScgqF_Nt2oro4vkwrjLUR36nkICagqSrUhelCMHjalbBp_Hyg/viewform?usp=sf_link"
          type="button" class="btn btn-warning mt-3 mb-3 ml-2" target="_blank"><i class="fas fa-solid fa-hand-holding"></i> &nbsp;&nbsp;<b>Kembalikan
          Barang</b></a>
          <br />
          <br />
          <table id="lembaga" class="table table-striped table-bordered mt-2 mb-2" style="width: 100%"></table>
          <br />
          <br />
          <p id="passingGrade"></p>
        </div>
    ...
    $(document).ready(function () {
      ...
      $("#lembaga").DataTable({
        ...
        },  
        {
          ...
          {
            title: "Lembaga Peminjam",
            data: "Lembaga Peminjam",
          },
          {
