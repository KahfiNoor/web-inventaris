...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="kembali_anggota.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fas fa-user fa-fw"></i> Pengembalian Anggota</a>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $("#anggota").DataTable({
        ajax: "https://script.google.com/macros/s/AKfycbyk3OI-RG4gyRILrsIY0Gc_pB45fjYERpwNX_bAZAOq118xTk-NgoeFaeavopAn5fWB/exec",
        columns: [
        {
            title: "No.",
            data: null,
